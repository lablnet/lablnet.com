...
<div :class="appTheme">
    ...
    <div class="dark:text-white light-text-color">
        ...
        " ref="nav">
            <router-link class="block" :to="{ path: '/' }">
                ...
                <img class="" src="./assets/images/muf.png" alt="Logo" width="50" height="50" title="Logo" />
            </router-link>
            <span class="inline-block mx-auto mr-1 mt-1 md:hidden">
                <ThemeChanger :theme="appTheme" /></span>

            <button @click="mobileMenuOpen = !mobileMenuOpen" class="inline-block md:hidden w-8 h-8 p-1">
          ...
          " :class="{ flex: mobileMenuOpen, hidden: !mobileMenuOpen }" click="mobileMenuOpen = false">
                <router-link :to="{ path: path, hash: '#projects' }" class="block py-1" @click="mobileMenuOpen = false">Projects</router-link>
                <router-link :to="{ path: path, hash: '#skills' }" class="block py-1" @click="mobileMenuOpen = false">SKills</router-link>
                <router-link :to="{ path: path, hash: '#education' }" class="block py-1" @click="mobileMenuOpen = false">Education</router-link>
                <router-link :to="{ path: path, hash: '#certificates' }" class="block py-1" @click="mobileMenuOpen = false">Certificates</router-link>
                <router-link to="/quotes" class="block py-1" @click="mobileMenuOpen = false">Quotes</router-link>
                <router-link :to="{ path: path, hash: '#contact' }" class="block py-1" @click="mobileMenuOpen = false">Contact</router-link>
        ...
        <footer class="text-gray-600 body-font">
            ...
            ">
              ...
              ">
                        <span class="ml-3">
                            <img src="./assets/images/muf.png" style="width: 80px; height 80px;" alt="Muhammad Umer Farooq" />
                        </span>
                    </router-link>
                    <p class="inline-flex text-sm text-gray- 500 sm:ml-6 sm:mt-0 mt-4">
                        ...
                        &nbsp; By &nbsp;
                        <a class="font-bold" href="https://github.com/lablnet" target="_blank">Muhammad Umer Farooq</a>
                    </p>
                    <span class="
                inline-flex
                sm:ml-auto sm:mt-0
                ...
                sm:justify-start
              ">
                        <a href="https://github.com/lablnet" target="_blank" class="ml-3 text-gray-500">
                            <img style="width: 1.6em; height: 1.6em" :src="
                  ...
                  " />
                        ...
                        <a v-for="media in medias" :key="media" :href="media.link" target="_blank" class="ml-3 text-gray-500">
                            <img style="width: 1.6em; height: 1.6em" :src="media.picture" />
                        </a>
                        <a href="https://linkedin.com/in/lablnet" target="_blank" class="ml-3 text-gray-500">
                            <img style="width: 1.6em; height: 1.6em" :src="
                    require(this.appTheme === 'dark'
    ...
    <button v-if="top" class="backtotop bg-gray-300" v-on:click="scrollTop()" title="Go to top">
