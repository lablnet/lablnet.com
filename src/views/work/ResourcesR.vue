<template>
  ...
  >
    <PostInfo
      ...
      siteURL="https://play.google.com/store/apps/details?id=resourcesr.web.app"
    />
    ...
    <PostInfo
      ...
      codeURL="resourcesr/web"
      siteURL="https://resourcesr.web.app/"
    />
