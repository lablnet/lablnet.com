const id = "others_fontpicker.md";
						const collection = "projects";
						const slug = "fontpicker";
						...
						const data = {startDate:new Date(1624665600000),endDate:new Date(1625184000000),title:"Font Picker",stacks:["HTML","CSS","JavaScript","Python"],company:"projects",live:"https://lablnet.github.io/fontpicker/",github:"lablnet/fontpicker",featured:false,draft:false};
						const _internal = {
							type: 'content',
							filePath: "D:/umer/projects/lablnet/lablnet.com/src/content/projects/others_fontpicker.md",
							rawData: undefined,
						};
