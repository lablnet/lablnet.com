const id = "upwork_amazon.md";
						...
						const data = {startDate:new Date(1716595200000),endDate:new Date(1717200000000),title:"Amazon Product scraping",stacks:["NodeJs","Playwright"],company:"upwork",collaborators:[{name:"Muhammad Umer Farooq",picture:"../../assets/images/umer.jpg"}],live:"https://www.upwork.com/jobs/~01c74972012086824b",featured:false,draft:false};
						const _internal = {
							type: 'content',
