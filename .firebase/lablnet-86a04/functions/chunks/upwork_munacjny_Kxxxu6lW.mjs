const id = "upwork_munacjny.md";
						const collection = "projects";
						const slug = "upwork_munacjny";
						...
						const data = {startDate:new Date(1661558400000),endDate:new Date(1663804800000),title:"Web based Student Information System",stacks:["Laravel","Vue","TailwindCSS","MySQL","PHP"],company:"upwork",collaborators:[{name:"Muhammad Umer Farooq",picture:"../../assets/images/umer.jpg"}],live:"https://sis.munacjny.org/",featured:false,draft:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/lablnet/projects/lablnet/lablnet.com/src/content/projects/upwork_munacjny.md",
							rawData: undefined,
						};
