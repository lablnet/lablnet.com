const id = "other_alibabascrapper.md";
						const collection = "projects";
						const slug = "alibabascrapper";
						...
						const data = {startDate:new Date(1707264000000),endDate:new Date(1707955200000),title:"Multi-Threaded Alibaba Scrapper",stacks:["JavaScript","Playwright"],company:"projects",github:"lablnet/alibaba_scrapper",featured:false,draft:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/lablnet/projects/lablnet/lablnet.com/src/content/projects/other_alibabascrapper.md",
							rawData: undefined,
						};
