const id = "upwork_bungalowsoftware.md";
						const collection = "projects";
						const slug = "upwork_bungalowsoftware";
						...
						const data = {startDate:new Date(1610928000000),endDate:new Date(1614124800000),title:"Set up shopping cart using Stripe.com Checkout (PhP)",stacks:["PHP","HTML","CSS","JavaScript","Stripe"],company:"upwork",collaborators:[{name:"Muhammad Umer Farooq",picture:"../../assets/images/umer.jpg"}],live:"https://www.bungalowsoftware.com/subscription/buy/",featured:false,draft:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/lablnet/projects/lablnet/lablnet.com/src/content/projects/upwork_bungalowsoftware.md",
							rawData: undefined,
						};
