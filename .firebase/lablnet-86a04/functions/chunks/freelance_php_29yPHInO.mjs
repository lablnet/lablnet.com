const id = "freelance_php.md";
						const collection = "projects";
						const slug = "freelance_php";
						...
						const data = {startDate:new Date(1606780800000),endDate:new Date(1606780800000),title:"PHP out mysql data",stacks:["PHP","MySQL"],company:"freelance",collaborators:[{name:"Muhammad Umer Farooq",picture:"../../assets/images/umer.jpg"}],live:"https://www.freelancer.com/projects/php/Php-out-mysql-data",featured:false,draft:false};
						const _internal = {
							type: 'content',
							filePath: "D:/umer/projects/lablnet/lablnet.com/src/content/projects/freelance_php.md",
							rawData: undefined,
						};
