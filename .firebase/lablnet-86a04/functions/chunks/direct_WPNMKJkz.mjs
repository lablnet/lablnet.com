const id = "direct.md";
						...
						const data = {startDate:new Date(1613088000000),title:"Direct Client",name:"Projects",link:"https://www.lablnet.com/",featured:false,type:"company",draft:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/lablnet/projects/lablnet/lablnet.com/src/content/companies/direct.md",
							rawData: undefined,
						};
