const id = "direct_ lumberjackgame.md";
						const collection = "projects";
						const slug = "direct_lumberjackgame";
						...
						const data = {startDate:new Date(1628294400000),endDate:new Date(1628726400000),title:"LumberJack Game",stacks:["HTML","CSS","JavaScript","Jquery","Firebase"],company:"direct",collaborators:[{name:"Muhammad Umer Farooq",picture:"../../assets/images/umer.jpg"}],live:"8https://lablnet.github.io/LumberJack-game/v2/index.html",featured:false,draft:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/lablnet/projects/lablnet/lablnet.com/src/content/projects/direct_ lumberjackgame.md",
							rawData: undefined,
						};
