const id = "direct_ainda.md";
						const collection = "projects";
						const slug = "direct_ainda";
						...
						const data = {startDate:new Date(1561939200000),endDate:new Date(1564531200000),title:"AINDA",stacks:["HTML","CSS","JavaScript","Cordova"],company:"direct",collaborators:[{name:"Muhammad Umer Farooq",picture:"../../assets/images/umer.jpg"}],live:"https://play.google.com/store/apps/details?id=com.practicalvalue.ainda&hl=en",featured:false,draft:false};
						const _internal = {
							type: 'content',
							filePath: "D:/umer/projects/lablnet/lablnet.com/src/content/projects/direct_ainda.md",
							rawData: undefined,
						};
