...
const html = "<p>As a Top Rated freelancer on Upwork for the past two years, I have successfully completed over 82 projects and have received a 5-star rating on 90% of them. While I am unable to list all of my projects, I am proud to highlight a few of my most notable achievements.</p>";
				...
				const file = "D:/umer/projects/lablnet/lablnet.com/src/content/companies/upwork.md";
				const url = undefined;
				function rawContent() {
