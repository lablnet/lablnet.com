const id = "direct_spendbtc.md";
						const collection = "projects";
						const slug = "direct_spendbtc";
						...
						const data = {startDate:new Date(1561939200000),endDate:new Date(1564531200000),title:"SpendBTC",stacks:["WordPress","PHP","HTML","CSS","JavaScript","Jquery"],company:"direct",collaborators:[{name:"Muhammad Umer Farooq",picture:"../../assets/images/umer.jpg"}],live:"https://spendbtc.io/",featured:false,draft:false};
						const _internal = {
							type: 'content',
							filePath: "D:/umer/projects/lablnet/lablnet.com/src/content/projects/direct_spendbtc.md",
							rawData: undefined,
						};
