const id = "upwork_replay.md";
						const collection = "projects";
						const slug = "replay-connect";
						...
						const data = {startDate:new Date(1690070400000),endDate:new Date(1692662400000),title:"Replay Connect",stacks:["TypeScript","JavaScript","Firebase","Functions","Vue","TailwindCSS"],company:"upwork",collaborators:[{name:"Muhammad Umer Farooq",picture:"../../assets/images/umer.jpg"}],live:"https://superadmin.replay-connect.com/",featured:false,draft:false};
						const _internal = {
							type: 'content',
							filePath: "D:/umer/projects/lablnet/lablnet.com/src/content/projects/upwork_replay.md",
							rawData: undefined,
						};
