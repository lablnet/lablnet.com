const id = "upwork_robotmk-curriculum.md";
						...
						const data = {startDate:new Date(1715126400000),endDate:new Date(1715731200000),title:"Robotmk Curriculum",stacks:["JavaScript","Cloudflare Worker","GitHub Actions"],company:"upwork",collaborators:[{name:"Muhammad Umer Farooq",picture:"../../assets/images/umer.jpg"}],live:"https://www.upwork.com/jobs/~0189a03f69f206b9b5",featured:false,draft:false};
						const _internal = {
							type: 'content',
